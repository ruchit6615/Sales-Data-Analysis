...
### Product Performance
![Product Performance](images/Dashboard_Page_1_Product_Performance.png)

### Sales Overview
![Sales Overview](images/Dashboard_Page_2_Sales_Overview.png)

### Detailed Order Analysis
![Detailed Order Analysis](images/Dashboard_Page_5_Detailed_Data.png)

## 🚀 How to Use

### Option 1 — View the Dashboard

Open **`Sales_Data_Project.pdf`** to view all 5 pages of the completed dashboard.
...
| `Sales_Data_Project.pdf` | Complete 5-page dashboard |
| `Store_Data.xlsx` | Original Excel dataset |
